            ...
            <div className="suggestions__container">
                ...
                <div className="suggestions__body">
                    <div className="suggestions__friends">
                        ...
                        <div className="suggestions__username">Raheel</div>
                    </div>
                    <div className="suggestions__friends">
                        <Avatar src={imageSrc2} className="suggestions__image"/>
                        <div className="suggestions__username">Imran Khan</div>
                    </div>
                    <div className="suggestions__friends">
                        <Avatar src={imageSrc3} className="suggestions__image"/>
                        <div className="suggestions__username">Cristiano Ronaldo</div>
                    </div>
                    <div className="suggestions__friends">
                        <Avatar src={imageSrc2} className="suggestions__image"/>
                        <div className="suggestions__username">Messi</div>
                    </div>
                    <div className="suggestions__friends">
                        <Avatar src={imageSrc3} className="suggestions__image"/>
                        <div className="suggestions__username">Babar Azam</div>
                    </div>
                </div>
            </div>
        </div> );
